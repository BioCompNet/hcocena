...
.hc_export_to_local_folder_legacy_driver <- export_to_local_folder
.hc_export_to_cytoscape_legacy_driver <- export_to_cytoscape
.hc_import_layout_from_cytoscape_legacy_driver <- import_layout_from_cytoscape
.hc_import_layout_from_local_folder_legacy_driver <- import_layout_from_local_folder
